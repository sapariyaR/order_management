...
var AdminLayoutRoutes = [
    ...
    { path: 'admin/user-profile', component: _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_1__["UserProfileComponent"] }
];
